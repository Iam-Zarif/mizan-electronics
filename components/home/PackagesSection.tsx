          ...
          {packages.map((pack) => (
            ...
            >
              ...
              <div className="mt-auto flex flex-col sm:flex-row gap-2">
                <Link
                  href={`${messengerBase}${encodeURIComponent(`https://mizanelectronics.vercel.app/services\nI want to book ${pack.title}`)}`}
                  target="_blank"
                ...
                <Link
                  href={`${whatsappBase}${encodeURIComponent(`https://mizanelectronics.vercel.app/services\nI want to book ${pack.title}`)}`}
                  target="_blank"
