          ...
          {packages.map((pack) => (
            ...
            >
              ...
              <div className="mt-auto flex flex-col sm:flex-row gap-2">
                <Link
                  href={`${messengerBase}${encodeURIComponent(`I want to book ${pack.title}\nhttps://mizan-electronics.vercel.app/services`)}`}
                  target="_blank"
                ...
                <Link
                  href={`${whatsappBase}${encodeURIComponent(`I want to book ${pack.title}\nhttps://mizan-electronics.vercel.app/services`)}`}
                  target="_blank"
